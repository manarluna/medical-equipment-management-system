...
<title>ME2MS — Manual Library</title>
        ...
        <div class="topbar">
            <div class="topbar-left">
                <div class="topbar-breadcrumb">
                    ...
                    <span style="color:var(--text);font-weight:500;">Manual Library</span>
                </div>
            </div>
        ...
        <div class="content">
            ...
            <div class="page-hero">
                <div style="position:relative;z-index:2;">
                    ...
                    <p>// <%= manuals.size() %> Document<%= manuals.size()!=1?"s":"" %>Available <%= manuals.size()!=1?"s":"" %></p>
                </div>
                <% if (isManager) { %>
                <div style="position:relative;z-index:2;">
            ...
            <div class="doc-toolbar">
                <div style="display:flex;align-items:center;gap:.7rem;">
                    <div class="search-wrap">
                        ...
                        <input type="text" placeholder="Rechercher par titre…" oninput="searchManuals(this.value)"/>
                    </div>
            ...
            <div class="empty-state">
                ...
                <% if (isManager) { %>
                <p style="font-size:.75rem;margin-top:.4rem;">Use the "Upload a Manual"button to add one </p>
                <% } else { %>
                <p style="font-size:.75rem;margin-top:.4rem;">Contact the technical manager if needed</p>
                <% } %>
            </div>
            <% } else { %>
            ...
            <% for (Manual m : manuals) {
                ...
                String meqName = meq != null ? meq.getName() + " — " + meq.getAssetId() : "Équipement #" + m.getEquipmentId();
            ...
            <div class="manual-card" data-title="<%= m.getTitle().toLowerCase() %>">
                ...
                <div class="manual-card-body">
                    ...
                    <div class="manual-card-footer">
                        ...
                        <% if (isManager) { %>
                        <form method="post" action="<%= request.getContextPath() %>/manuals" style="display:inline;" onsubmit="return confirm('Supprimer ce manuel ?');">
...
function searchManuals(q) {
    ...
    document.getElementById('manualCount').textContent = count + ' résultat' + (count !== 1 ? 's' : '');
}
</script>
</body>
</html>
