...
<title>ME2MS — Tableau de bord Infirmier(e)</title>
        ...
        <div class="content">
            ...
            <div class="page-hero">
                <div style="position:relative;z-index:2;">
                    <h1>🏥 Bonjour, <%= currentUser.getFirstName() %></h1>
                    <p>// <%= myReports.size() %> rapports · <%= pendingCount %> en attente · <%= resolvedCount %> résolus</p>
                </div>
            ...
            <div class="stats-grid" style="margin-bottom:1.5rem;">
                <div class="stat-card"><div class="stat-icon gold"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg></div><div><div class="stat-value"><%= pendingCount %></div><div class="stat-label">En attente</div></div></div>
                <div class="stat-card"><div class="stat-icon slate"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/></svg></div><div><div class="stat-value"><%= inProgressCount %></div><div class="stat-label">En cours</div></div></div>
                <div class="stat-card"><div class="stat-icon sky"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg></div><div><div class="stat-value"><%= resolvedCount %></div><div class="stat-label">Résolus</div></div></div>
            ...
            <!-- RECENT REPORTS -->
            <div class="section-label"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="13" height="13"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/></svg>Mes derniers rapports</div>
            <div class="card" style="margin-bottom:1.5rem;">
                <div class="card-header">
                    <h3><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="color:#0096C7;"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/></svg>Rapports de panne</h3>
                    <a href="<%= request.getContextPath() %>/faultreports" class="btn btn-outline btn-sm">Voir tout</a>
                </div>
                <div class="table-wrap">
                    <% if (myReports.isEmpty()) { %>
                    <div class="empty-state"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" width="36" height="36"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/></svg><p>Aucun rapport soumis pour l'instant.</p></div>
                    <% } else { %>
                    <table>
                        <thead><tr><th>#</th><th>Équipement</th><th>Salle</th><th>Description</th><th>Urgence</th><th>Statut</th><th>Date</th></tr></thead>
                        <tbody>
                        ...
                        <tr>
                            ...
                            <td style="font-size:.8rem;font-weight:600;">Équip. #<%= r.getEquipmentId() %></td>
            ...
            <!-- EQUIPMENT -->
            <div class="section-label"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="13" height="13"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/></svg>Équipements de mon service</div>
            <% if (myEquipment.isEmpty()) { %>
            <div class="card"><div class="empty-state"><p>Aucun équipement associé à votre service.</p></div></div>
            <% } else { %>
