...
<%
    ...
    if (equipmentList == null) {
        // FIX: use getByUser(userId) instead of getByDepartment(getDepartmentId())
        // getDepartmentId() was always returning 0 since department_id is not in the users table
        equipmentList = Equipment.getByUser(currentUser.getUserId());
        if (equipmentList == null || equipmentList.isEmpty()) {
            equipmentList = Equipment.liste(); // safety fallback: show all equipment
        }
    }
